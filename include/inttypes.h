 ...
 *
 *  Created on: 2017年7月13日, 下午4:39:02
 *      Author: victor 
 *   Toolchain: 
 *    Language: C/C++
 * description:
...
__DeclareFunc__(imaxdiv_t, imaxdiv, (intmax_t numer, intmax_t denomer));
__DeclareFunc__(intmax_t , strtoimax, (const char * RESTRICT , char **RESTRICT , int));
__DeclareFunc__(uintmax_t, strtoumax, (const char * RESTRICT , char **RESTRICT , int));
