...
inline int yaffs_start_up(void){ extern struct list_head yaffsfs_deviceList; yaffsfs_deviceList.next = yaffsfs_deviceList.prev = &yaffsfs_deviceList; return 0; }
inline int yaffsfs_GetLastError(void){ return (errno); }
